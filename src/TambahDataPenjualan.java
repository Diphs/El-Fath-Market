...
public class TambahDataPenjualan extends javax.swing.JFrame {

    /**
     * Creates new form TambahDataPenjualan1
     */
    ...
    private void autonumber(){
        try {
            ...
            if (r.next()) {
                ...
                {Nol = "";}
                txNoTransaksi.setText("PJ" + Nol + TR);
            } else {
                txNoTransaksi.setText("PJ0001");
            }
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("TAMBAH DATA PENJUALAN");
    ...
    private void btn_simpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_simpanActionPerformed
        ...
        try {
            String sql = "INSERT INTO `penjualan`(`kd_penjualan`, `waktu`, `kd_karyawan`) VALUES ('"+noTransaksi+"','"
        ...
        try {
            ...
            for (int i = 0; i < baris; i++) {
                String sql = "INSERT INTO `detail_penjualan` (`id_pjl`, `jumlah`, `total_harga`, `kd_produk`, `kd_penjualan`) VALUES (NULL, '"
