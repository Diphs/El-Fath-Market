...
public class Pembelian extends javax.swing.JFrame {
    ...
    UbahDataPembelian jtRowData = new UbahDataPembelian();
    ...
    private void load_table(){
        ...
        try {
            ...
            " FROM detail_pembelian JOIN produk ON detail_pembelian.kd_produk=produk.kd_produk "
                    + "JOIN pembelian ON detail_pembelian.kd_pembelian=pembelian.kd_pembelian JOIN karyawan on pembelian.kd_karyawan=karyawan.kd_karyawan"+
            " ORDER BY kd_pembelian asc";
    ...
    private void initComponents() {
        ...
        lbl_pembelian.setForeground(new java.awt.Color(102, 102, 102));
        lbl_pembelian.setIcon(new javax.swing.ImageIcon("D:\\Project5A\\pembelian.png")); // NOI18N
        ...
        jTablepembelian.setFont(new java.awt.Font("Yu Gothic UI", 0, 14)); // NOI18N
    ...
    private void btn_ubahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ubahActionPerformed
        ...
        String kd_pembelian = model.getValueAt(index, 0).toString();
        ...
        jtRowData.txt_kdPembelian.setText(kd_pembelian);
        jtRowData.txt_kdPembelian.disable();
...
//        new UbahDataPembelian().setVisible(true);
    ...
    private void btn_hapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_hapusActionPerformed
        ...
        try {
            ...
            TableModel model = jTablepembelian.getModel();
            String kd_pembelian = model.getValueAt(index, 0).toString();
            String sql = "DELETE FROM pembelian WHERE kd_pembelian ='"+kd_pembelian+"'";
             String sql1 = "DELETE FROM detail_pembelian WHERE kd_pembelian ='"+kd_pembelian+"'";
            java.sql.Connection conn = (Connection)Config.configDB();
